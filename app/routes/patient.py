...
def bornes_date_naissance():
    """Retourne (min, max) autorisés pour la date de naissance : pas aujourd'hui ni le futur
    (un nouveau-né peut être inscrit dès le jour suivant sa naissance), pas plus de 120 ans."""
    today = date.today()
